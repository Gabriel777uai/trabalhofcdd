  ...
  class S {
    ...
    clone(e, t) {
      ...
      let o = t.substr.substring(0, e - n.start),
        r = o.length;
      return (
        s.add({ start: n.start, end: n.start + r, length: r, substr: o }),
        s
      );
    }
  }
      ...
      for (let i = 0; i < e.length; i++) {
        ...
        for (const e of s) {
          ...
          if (!t || 1 == t.length || t.end <= i)
            if (r) {
              const t = r.length;
              (e.add({ start: i, end: i + t, length: t, substr: r }),
                a.add("1"));
            } else
              (e.add({ start: i, end: i + 1, length: 1, substr: o }),
                a.add("2"));
          else if (r) {
            let s = e.clone(i, t);
            const n = r.length;
  ...
  class ce extends (function (e) {
    ...
    constructor(e, t) {
      ...
      if (
        ...
        n.controlInput
          ? ((p = K(n.controlInput)), (this.focus_node = p))
          : ((p = K("<input/>")), (this.focus_node = l));
      ((this.wrapper = r),
        (this.dropdown = a),
    ...
    refreshOptions(e = !0) {
      ...
      const b = (e, t) => {
        ...
        return (
          (s = p.length),
          p.push({ fragment: i, order: t, optgroup: e }),
          [s, i]
        );
      };
      for (t = 0; t < n; t++) {
